...
export default function Header() {
    ...
    const navigationClassName = classnames(
        ...
        "fixed top-0 flex-col transition-all duration-300 md:w-auto w-3/6 md:py-0 py-3 px-3",
        {
            "-right-72": !navOpen,
            "right-0": navOpen
        }
    ...
    return(
        <header className={"m-auto fixed w-full top-0 left-0 h-16 bg-theme-light-100 dark:bg-theme-dark-100 grid place-items-center z-50"}>
                ...
                <div className={"flex-1 flex md:justify-start justify-end"}>
                    <nav role={"navigation"}
                        ...
                        <div className={"md:hidden flex justify-between items-center"}>
                            <p className={"text-typo-dark-100 font-light "}>
                                Menu
                            </p>
